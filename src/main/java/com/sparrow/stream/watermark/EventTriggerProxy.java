...
public class EventTriggerProxy extends Trigger<WatermarkElement, TimeWindow> {
    ...
    public TriggerResult onEventTime(long time, TimeWindow window, TriggerContext ctx) throws Exception {
        System.out.println("element time:"+DateFormatUtils.format(time,DateFormatUtils.ISO_DATETIME_FORMAT.getPattern())+" window:"+DateFormatUtils.format(window.getStart(),DateFormatUtils.ISO_DATETIME_FORMAT.getPattern())+"-"+DateFormatUtils.format(window.getEnd(),DateFormatUtils.ISO_DATETIME_FORMAT.getPattern()));
